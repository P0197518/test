...
/**
 * <HR>
 * プロジェクト編集画面の入力値の取得及び入力値有効性のチェックを行う
 * <P>
 * このクラスでは以下の処理を行う。
 * <ul>
 * <li>プロジェクト編集の入力値を取得</li>
 ...
 */
public class SVNM0212Bean extends BaseBean {
    ...
    public ActionErrors validate(ActionMapping mapping,
        ...
        // ログ出力
        log.printLog("INFO", "SVNM0212Bean", String.valueOf((new Throwable())
        ...
        try {
            ...
            // 別の画面から遷移した場合、チェックはしない。
            else if (!pageId.split(",")[0].equals("SVNM0212")
            ...
            // SVNフォルダ名は入力していない場合
                ...
                setHidError(svnmError("SVNM0212Bean", "svnFolderName"));
            }
            ...
            // プロジェクト名は入力しない。
                ...
                setHidError(svnmError("SVNM0212Bean", "projectName"));
            }
            // プロジェクト名は日本語じゃない。
            ...
            // ＰＪ責任者は選択しない。
                ...
                setHidError(svnmError("SVNM0212Bean", "pjMaster"));
            }
            // ＰＪリーダは選択しない。
                ...
                setHidError(svnmError("SVNM0212Bean", "pjLeader"));
            }
            // プロジェクト開始日は選択しない。
                ...
                setHidError(svnmError("SVNM0212Bean", "pjStartDate"));
            }
            // プロジェクト完了日は選択しない。
                ...
                setHidError(svnmError("SVNM0212Bean", "pjEndDate"));
            }
            // プロジェクト開始日はプロジェクト完了日以降の場合
                ...
                setHidError(svnmError("SVNM0212Bean", "pjStartDate")
                        + svnmError("SVNM0212Bean", "pjEndDate"));
            }
            // フォルダ移動日は選択しない。
                ...
                setHidError(svnmError("SVNM0212Bean", "pjRemoveDate"));
            }
            ...
            // メンバーは選択しない。
                ...
                setHidError(svnmError("SVNM0212Bean", "member"));
            }
            // 入力したコメントは100桁じゃない。
                ...
                setHidError(svnmError("SVNM0212Bean", "comment"));
            }
            ...
            // ログ出力
            log.printLog("ERROR", "SVNM0212Bean", String.valueOf((new Throwable())
