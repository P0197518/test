...
public @interface ValidatePhone {
     ...
     * 
     */
    class PhoneValidator implements ConstraintValidator<ValidatePhone, String> {

        /** Phoneドメイン許容 */
        private static String phoneDomain = "[^1(3|4|5|7|8)\\d{9}$]";

        /** メールアドレスチェックドメイン許容 */
        private final Pattern domainPattern = java.util.regex.Pattern.compile(phoneDomain);

        /** 最大桁数 */
        private int maxlength;

        @Override
        public void initialize(ValidatePhone validPhone) {
