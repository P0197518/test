...
public class EasypoiBigExcelExportView extends MiniAbstractExcelView {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Workbook workbook = ExcelExportUtil.exportBigExcel((ExportParams) model.get(BigExcelConstants.PARAMS),
                        (Class<?>) model.get(BigExcelConstants.CLASS), (IExcelExportServer) model.get(BigExcelConstants.DATA_INTER),
