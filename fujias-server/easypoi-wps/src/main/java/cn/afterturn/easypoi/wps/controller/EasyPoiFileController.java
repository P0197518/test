...
public class EasyPoiFileController {
     ...
     */
    @PostMapping("save")
    public WpsFileSaveResponse fileSave(HttpServletRequest request, @RequestParam(value = "_w_userid", required = false) String userId,
    ...
    public WpsFileSaveResponse fileVersion(HttpServletRequest request, @PathVariable Integer version, @RequestParam("_w_filepath") String filePath) {
