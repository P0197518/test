 ...
 * 解析实体类对象 复用注解
 *
 * @author JueYue 2014年8月9日 下午10:30:57
 */
public class ExcelEntityParse extends ExportCommonService {
     ...
     * @throws Exception
     */
    public void createListCells(int index, int cellNum, Object obj, List<ExcelExportEntity> excelParams, XWPFTable table, short rowHeight)
                    throws Exception {
        ExcelExportEntity entity;
        XWPFTableRow row;
