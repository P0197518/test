...
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.BOOLEAN;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.COL;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.DATE;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.FORMULA;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.INLINE_STR;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.NUMBER;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.ROW;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.ROW_COL;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.STRING;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.STYLE;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.TYPE;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.T_ELEMENT;
import static cn.afterturn.easypoi.excel.entity.sax.SaxConstant.VALUE;
 ...
 * 回调接口
 *
 * @author JueYue 2014年12月29日 下午9:50:09
 */
        ...
        if (COL.equals(name)) {
            ...
            try {
                ...
                if (StringUtils.isNotEmpty(numberFormat)) {
                    if (numberFormat.contains("Y") || numberFormat.contains("M") || numberFormat.contains("D") || numberFormat.contains("H")
                                    || numberFormat.contains("S") || numberFormat.contains("年") || numberFormat.contains("月")
                                    || numberFormat.contains("日") || numberFormat.contains("时") || numberFormat.contains("分")
                                    || numberFormat.contains("秒")) {
                        type = CellValueType.Date;
                        return;
                    }
                }
