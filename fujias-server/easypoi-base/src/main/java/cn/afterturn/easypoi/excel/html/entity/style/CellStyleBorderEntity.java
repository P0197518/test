 ...
 * 边框样式
 * 
 * @author JueYue 2016年4月3日 上午10:35:28
 */
public class CellStyleBorderEntity {
    ...
    public String toString() {
        return new StringBuilder().append(borderLeftColor).append(borderRightColor).append(borderTopColor).append(borderBottomColor)
                        .append(borderLeftStyle).append(borderRightStyle).append(borderTopStyle).append(borderBottomStyle).append(borderLeftWidth)
                        .append(borderRightWidth).append(borderTopWidth).append(borderBottomWidth).toString();
