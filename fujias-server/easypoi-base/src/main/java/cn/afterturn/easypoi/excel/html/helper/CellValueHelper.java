 ...
 * Cell值帮助类
 * 
 * @author JueYue 2015年5月9日 下午10:31:32
 */
public class CellValueHelper {
    ...
    private void cacheFontInfo(Workbook wb) {
        for (short i = 0, le = wb.getNumberOfFonts(); i < le; i++) {
            ...
            fontCache.put(font.getBold() + "_" + font.getItalic() + "_" + font.getFontName() + "_" + font.getFontHeightInPoints() + "_"
                            + font.getColor(), font.getIndex() + "");
        }
    ...
    private String getFontIndex(XSSFFont font) {
        return fontCache.get(font.getBold() + "_" + font.getItalic() + "_" + font.getFontName() + "_" + font.getFontHeightInPoints() + "_"
                        + font.getColor());
    }
}
