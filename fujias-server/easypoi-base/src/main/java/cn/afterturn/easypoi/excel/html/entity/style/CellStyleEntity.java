 ...
 * Cell 具有的样式
 * 
 * @author JueYue 2016年3月20日 下午4:56:51
 */
public class CellStyleEntity {
    ...
    public String toString() {
        return new StringBuilder().append(align).append(background).append(border).append(height).append(vetical).append(width).append(font)
                        .toString();
    }
