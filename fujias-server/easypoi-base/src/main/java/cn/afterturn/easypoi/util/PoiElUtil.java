 ...
 * EasyPoi的el 表达式支持工具类
 *
 * @author JueYue 2015年4月25日 下午12:13:21
 */
public final class PoiElUtil {
    ...
    public static final String FORMULA_SYMBOL = "f:";
    ...
    private static Object calculate(String text, Map<String, Object> map) throws Exception {
        ...
        for (int i = 0; i < chars.length; i++) {
            if (operations[0] == chars[i] || operations[1] == chars[i] || operations[2] == chars[i] || operations[3] == chars[i]
                            || operations[4] == chars[i] || operations[5] == chars[i]) {
                if (temp.length() > 0) {
