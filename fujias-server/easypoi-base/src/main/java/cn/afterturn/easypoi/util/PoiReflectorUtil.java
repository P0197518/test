 ...
 *
 * @author JueYue 参考的 mybatis的Reflector
 */
public final class PoiReflectorUtil {
            ...
            if (getters.size() == 1) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (methodType.equals(getterType)) {
                        throw new RuntimeException("Illegal overloaded getter method with ambiguous type for property " + propName + " in class "
    ...
    private void resolveSetterConflicts(Map<String, List<Method>> conflictingSetters) {
        for (String propName : conflictingSetters.keySet()) {
            ...
            if (setters.size() == 1) {
                ...
                if (setter == null) {
                    throw new RuntimeException("Illegal overloaded setter method with ambiguous type for property " + propName + " in class "
                                    + firstMethod.getDeclaringClass() + ".  This breaks the JavaBeans "
                                    + "specification and can cause unpredicatble results.");
                }
    ...
    /*
     * This method returns an array containing all methods declared in this class and any superclass. We use this method, instead of the simpler Class.getMethods(), because we want to look for private
     * methods as well.
     *
     * @param cls The class
     * 
