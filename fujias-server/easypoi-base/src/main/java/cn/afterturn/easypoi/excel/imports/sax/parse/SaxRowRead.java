...
public class SaxRowRead extends ImportBaseService implements ISaxRowRead {
    ...
    private void addListData(List<SaxReadCellEntity> datas) throws Exception {
        ...
        if (params.getKeyIndex() != null && (datas.get(params.getKeyIndex()) == null
                        || StringUtils.isEmpty(String.valueOf(datas.get(params.getKeyIndex()).getValue()))) && object != null) {
     ...
     * @throws Exception
     */
    private void addListContinue(Object object, ExcelCollectionParams param, List<SaxReadCellEntity> datas, Map<Integer, String> titlemap,
     ...
     * @throws Exception
     */
    private void saveFieldValue(ImportParams params, Object object, SaxReadCellEntity entity, Map<String, ExcelImportEntity> excelParams,
                    String titleString) throws Exception {
        if (Map.class.equals(pojoClass)) {
            ((Map) object).put(titleString, entity.getValue());
        } else {
            Object value = cellValueServer.getValue(params.getDataHandler(), object, entity, excelParams, titleString);
