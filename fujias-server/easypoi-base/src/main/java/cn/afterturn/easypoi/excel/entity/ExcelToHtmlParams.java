 ...
 * Excel到HTML的参数
 * 
 * @author JueYue 2015年8月7日 下午1:45:46
 */
@Data
public class ExcelToHtmlParams {
    ...
    /**
     * -- 图片保存路径,/开始或者含有: 认为是绝对路径,其他是相对路径,每次img名称随机生成,按照天生成文件夹 -- 不生成图片了直接BASE64Encoder 不为空就认为显示图片
     */
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ExcelToHtmlParams) {
            ...
            if (!this.wb.equals(other.getWb()) || this.completeHTML != other.completeHTML || this.sheetNum != other.getSheetNum()) {
                return false;
            }
