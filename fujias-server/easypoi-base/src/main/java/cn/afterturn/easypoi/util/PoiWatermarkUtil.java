...
/**
 * 水印工具类,WPS仅支持打印水印 参考 https://jingyan.baidu.com/article/6d704a137cd29d28db51ca87.html
 *
    ...
    static class VmlDrawing extends POIXMLDocumentPart {
        ...
        protected void commit() throws IOException {
            ...
            try {
                 ...
                 * 
                 * "<xml xmlns:oa=\"urn:schemas-microsoft-com:office:activation\"" + "    xmlns:p=\"urn:schemas-microsoft-com:office:powerpoint\"" + "    xmlns:x=\"urn:schemas-microsoft-com:office:excel\"" +
                 * "    xmlns:o=\"urn:schemas-microsoft-com:office:office\"" + "    xmlns:v=\"urn:schemas-microsoft-com:vml\">" + "    <o:shapelayout v:ext=\"edit\">" + "        <o:idmap v:ext=\"edit\" data=\"1\"/>"
                 * + "    </o:shapelayout>" + "    <v:shape id=\""+headerPos+"\" " + "        o:spid=\"_x0000_s1028\" o:spt=\"75\" alt=\"" + pictureTitle + "\"" + "        type=\"#_x0000_t75\"" +
                 ...
                 * "        filled=\"f\" o:preferrelative=\"t\" stroked=\"f\" coordsize=\"21600,21600\">" + "        <v:path/>" + "        <v:fill on=\"f\" focussize=\"0,0\"/>" + "        <v:stroke on=\"f\"/>" +
                 * "        <v:imagedata o:relid=\"" + rIdPic + "\" o:title=\"" + pictureTitle + "\"/>" + "        <o:lock v:ext=\"edit\" rotation=\"t\" aspectratio=\"t\"/>" + "    </v:shape>" + "</xml>"
                 * 
                 * );
                 */
                XmlObject doc = XmlObject.Factory.parse(
                                ...
                                "<xml xmlns:v=\"urn:schemas-microsoft-com:vml\"" + " xmlns:o=\"urn:schemas-microsoft-com:office:office\""
                                                ...
                                                + "  <o:lock v:ext=\"edit\" aspectratio=\"t\"/>" + " </v:shapetype><v:shape id=\"" + headerPos
                                                ...
                                                + "z-index:1'>" + "  <v:imagedata o:relid=\"" + rIdPic + "\" o:title=\"" + pictureTitle + "\"/>"
