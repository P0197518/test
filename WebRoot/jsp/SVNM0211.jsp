...
<html:html>
    <head>
        ...
        <script type="text/javascript">
            ...
            //確定ボタンを押下することの処理
            function kakuTei() {
                document.forms[0].pageId.value="SVNM0211,ok";
            }
            //戻るボタンを押下することの処理
            function modoRu() {
                document.forms[0].pageId.value="SVNM0211,return";
            }
    ...
    <body style="margin-top: 0;">
        <html:form action="SVNM0211.do">
            <div>
                ...
                <table cellspacing="1" cellpadding="3" width="70%" border="0" style="margin-left:0;" bgcolor="#999999">
                    ...
                    <tr class="TR01">
                        ...
                        <td class="TD02">
                            <html:textarea property="comment" styleClass="TEXTAREA01" style="height:80px;width:69.5%;word-break:break-all" />
                        </td>
                    </tr>
                </table>
            ...
            <html:hidden property="pageId" value="SVNM0211"/>
            <bean:write name="SVNM0211Bean" property="hidError" filter="false"/>
        </html:form>
    </body>
    <script type="text/javascript">
